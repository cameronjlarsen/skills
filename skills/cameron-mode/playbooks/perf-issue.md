...
3. Plan the fix from the trace. If it crosses a function boundary, `architect` first. Delegate implementation to a `cameron-agent` subagent using your configured perf-issue model; review the diff. Capture a post-fix trace.
...
6. Run **Opening an ADO PR** (`playbooks/opening-ado-pr.md`).
